"""
Tầng Model — kết nối CSDL và tám thực thể dữ liệu.

Khớp đúng models/schema.sql. File này chỉ khai báo cấu trúc và những luật
gắn liền với dữ liệu (phân quyền, nhãn hiển thị); truy vấn nghiệp vụ nằm ở
services.py và analytics.py.
"""
import os
